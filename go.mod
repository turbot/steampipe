...
replace (
	github.com/c-bata/go-prompt => github.com/turbot/go-prompt v0.2.6-steampipe.0.20211124090719-0709bc8d8ce2
	github.com/turbot/steampipe-plugin-sdk => /Users/binaeksarkar/work/sources/steampipe-plugin-sdk
)
