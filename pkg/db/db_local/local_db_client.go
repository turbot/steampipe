...
func GetLocalClient(ctx context.Context, invoker constants.Invoker, options ...db_client.DbClientConnectionOption) (*LocalDbClient, *error_helpers.ErrorAndWarnings) {
	...
	client, err := newLocalClient(ctx, invoker, options...)
	if err != nil {
...
func newLocalClient(ctx context.Context, invoker constants.Invoker, options ...db_client.DbClientConnectionOption) (*LocalDbClient, error) {
	...
	dbClient, err := db_client.NewDbClient(ctx, connString, options...)
	if err != nil {
