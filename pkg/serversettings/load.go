...
func Load(ctx context.Context, pool *sql.DB) (serverSettings *db_common.ServerSettings, e error) {
	...
	serverSettings, e = db_common.CollectOneToStructByName[db_common.ServerSettings](rows)
	return
}
