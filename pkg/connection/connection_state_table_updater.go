...
type connectionStateTableUpdater struct {
	updates *steampipe_config_local.ConnectionUpdates
	pool    *sql.DB
}

func newConnectionStateTableUpdater(updates *steampipe_config_local.ConnectionUpdates, pool *sql.DB) *connectionStateTableUpdater {
