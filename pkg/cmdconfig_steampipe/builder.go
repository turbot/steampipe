...
func (c *CmdBuilder) AddStringFlag(name string, defaultValue string, desc string, opts ...cmdconfig.FlagOption) *CmdBuilder {
...
func (c *CmdBuilder) AddIntFlag(name string, defaultValue int, desc string, opts ...cmdconfig.FlagOption) *CmdBuilder {
...
func (c *CmdBuilder) AddBoolFlag(name string, defaultValue bool, desc string, opts ...cmdconfig.FlagOption) *CmdBuilder {
...
func (c *CmdBuilder) AddStringSliceFlag(name string, defaultValue []string, desc string, opts ...cmdconfig.FlagOption) *CmdBuilder {
...
func (c *CmdBuilder) AddStringArrayFlag(name string, defaultValue []string, desc string, opts ...cmdconfig.FlagOption) *CmdBuilder {
...
func (c *CmdBuilder) AddStringMapStringFlag(name string, defaultValue map[string]string, desc string, opts ...cmdconfig.FlagOption) *CmdBuilder {
