...
func GetRootCertLocation() string {
	return filepath.Join(GetDataLocation(), localconstants.RootCert)
}

func GetRootCertKeyLocation() string {
	return filepath.Join(GetDataLocation(), localconstants.RootCertKey)
}

func GetServerCertLocation() string {
	return filepath.Join(GetDataLocation(), localconstants.ServerCert)
}

func GetServerCertKeyLocation() string {
	return filepath.Join(GetDataLocation(), localconstants.ServerCertKey)
}
