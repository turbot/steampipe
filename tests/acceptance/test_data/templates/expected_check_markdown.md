...
| | Reason | Dimensions |
|-|--------|------------|
| ❌ | some other resource is pretty insecure| `partition 10000` `us-east-2` `3335354343537`  |
...
| | Reason | Dimensions |
|-|--------|------------|
| ✅ | resource name is totally secure and this is qa very very very very very long reason| `partition 30000` `us-east-3` `21323354377537`  |
...
| | Reason | Dimensions |
|-|--------|------------|
| ❗ | some messed up resource is in some sort of error state| `partition 20000` `us-east-2` `21323354343537`  |
...
| | Reason | Dimensions |
|-|--------|------------|
| ℹ | resource name just some info, thought you should know| `partition 20000` `us-east-3` `21323354377537`  |
...
| | Reason | Dimensions |
|-|--------|------------|
| ⇨ | resource name totally skipping this one| `partition 40000` `us-east-4` `21323354377537`  |
