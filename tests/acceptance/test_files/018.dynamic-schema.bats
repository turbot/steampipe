...
@test "dynamic schema - add csv and query [DISABLED]" {
#  skip
...
@test "dynamic schema - add another column to csv and query the new column [DISABLED]" {
#  skip
 # run the query and verify - should pass
#  run steampipe query "select * from csv1.a"
...
@test "dynamic schema - remove the csv with extra column and query (should fail) [DISABLED]" {
#  skip
 # query the extra column and verify - should pass
#  run steampipe query 'select "column_D" from csv1.a'
#  assert_success
...
@test "dynamic schema - remove csv and query (should fail) [DISABLED]" {
#  skip
 # copy the csv file from csv source folder
