...
@test "dynamic schema - add csv and query TEST DISABLED" {
...
@test "dynamic schema - add another column to csv and query the new column TEST DISABLED" {
#  # run the query and verify - should pass
#  run steampipe query "select * from csv1.a"
#  assert_success
...
@test "dynamic schema - remove the csv with extra column and query (should fail) TEST DISABLED" {
#  # query the extra column and verify - should pass
#  run steampipe query 'select "column_D" from csv1.a'
#  assert_success
...
@test "dynamic schema - remove csv and query (should fail) TEST DISABLED" {
#  # copy the csv file from csv source folder
