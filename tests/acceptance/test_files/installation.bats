...
@test "check postgres database, fdw are correctly installed" {
  ...
  run file $target_install_directory/db/18.4.0-rc.1/postgres/bin/postgres
  ...
  run file $target_install_directory/db/18.4.0-rc.1/postgres/bin/initdb
  ...
  run file $target_install_directory/db/18.4.0-rc.1/postgres/lib/postgresql/steampipe_postgres_fdw.so
  if [[ "$arch" == "arm64" && "$os" == "Darwin" ]]; then
  ...
  run file $target_install_directory/db/18.4.0-rc.1/postgres/share/postgresql/extension/steampipe_postgres_fdw.control
