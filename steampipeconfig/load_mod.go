...
func createPseudoResources(modPath string, mod *modconfig.Mod, opts *LoadModOptions) error {
	...
	for _, path := range sourcePaths {
		...
		if resource != nil {
			reflectionData := getReflectionDataForPseudoResource(resource.Name(), mod, path, fileData)
...
func getReflectionDataForPseudoResource(name string, mod *modconfig.Mod, path string, fileData []byte) *modconfig.CoreReflectionData {
