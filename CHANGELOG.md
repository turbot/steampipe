...
* Add support for outputting `stdout` and `stderr` from `service start` to the `TRACE log`.  ([#810](https://github.com/turbot/steampipe/issues/810))
...
* Fix service lifecycle management issues when state file is deleted which service is running. ([#872](https://github.com/turbot/steampipe/issues/872))
